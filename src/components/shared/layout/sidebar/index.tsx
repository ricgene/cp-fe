...
const styles = {
  wrapper: {
    base: "max-md:absolute max-md:top-0 max-md:left-0 max-md:h-screen max-md:z-50 max-md:w-full max-md:-translate-x-full  max-md:ease-in-out max-md:transition-opacity max-md:duration-300 max-md:opacity-0",
